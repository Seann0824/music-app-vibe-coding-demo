  ...
  <div class="activity-page">
    ...
    <div class="tab-bar">
      <div class="tab-container">
        <div class="tab-bar-item" @click="switchPage('推荐')">
          <img class="tab-icon" src="/assets/home-icon.svg" alt="首页" />
          <div class="tab-label">首页</div>
        </div>
        <div class="tab-bar-item" @click="switchPage('唱片')">
        ...
        <div class="tab-bar-item active" @click="switchPage('动态')">
          <img class="tab-icon" src="/assets/activity-icon.svg" alt="动态" />
          <div class="tab-label">动态</div>
        </div>
        <div class="tab-bar-item" @click="switchPage('我的')">
